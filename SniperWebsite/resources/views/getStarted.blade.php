...
<form action="{{ url('/store')}}"  method="POST" enctype="multipart/form-data"  class="p-8 mt-6 mb-0 space-y-4 rounded-lg shadow-xl" >
      ...
      <div>
        <label for="city" class="text-md font-medium">City</label>
        <div class="relative mt-1">
          <input type="text" name="city" class="w-full p-4 pr-12 text-sm border-gray-200 rounded-lg shadow-sm" placeholder="Enter City"/>
        </div>
           <!--Error message-->
           @error('city')
